...
def welcome_message(client,me):
    ...
    if me.username+'.json' in os.listdir(path):
        ...
        print("script have no record of previous followers since it probably ran first time so will exit now and will send dms to new followers from now to next time it will run")
        return
